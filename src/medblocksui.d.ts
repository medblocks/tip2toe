...
declare global {
  namespace preact.createElement.JSX {
    interface IntrinsicElements {
      ...
      ['mb-form']: {path:string, ctx?: any, novalidate?: boolean, templateId?: string, nosuggest?: boolean, variant?: string, onMbSubmit?: (event: CustomEvent<object>) => void},
      ...
      ['mb-select']: {path: string, data?: string, terminology?: string, label?: string, id?: string, required?: boolean, placeholder?: string, disabled?: boolean, onMbInput?: (event: CustomEvent<string>) => void},
      ['mb-submit']: {label?: string, disabled?: boolean, onMbClick?: (event: CustomEvent<object>) => void},
