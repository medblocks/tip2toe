...
class FileUpload extends Component {
    ...
    onMbInputChange = (event) => {
        console.log(event.currentTarget.data); // or whatever the property is to access the value of the mb-input
    };
    ...
    render(_, { files, isLoading, isSubmitted, errorMessage }) {
        return (
            <div id={this.idUpload} className="file-upload">
                <mb-text-select hidden path={`${this.props.path}any_event:${0}/test_name`} onmb-input={this.onMbInputChange} ></mb-text-select>
                {!isSubmitted && (
