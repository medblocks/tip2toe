...
const HomePage: React.FC<HomePageHandlerProps> = ({ _authenticate }) => {
  ...
  const [ehrId, setehrId] = useState("5dd790d4-6bc6-47c9-a57f-2c3fdc164fda");
    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <svg class="h-16 w-16 m-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37.548 52.973">
            <defs>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <div>
              ...
              <div className="mt-2">
                <input
                  required
                  onChange={ele => setehrId(ele.currentTarget.value)}
                  value = {ehrId}
            ...
            <div>
              <div className="relative mt-10">
                ...
                <div className="relative flex justify-center text-sm font-medium leading-6">
                  <span className="bg-white px-6 text-gray-900">Continue As</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div>
                  <button
                    onClick={()=> _authenticate(ehrId,false)}
                    type="submit"
                ...
                <div>
                  <button
                    onClick={()=> _authenticate(ehrId,true)}
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Practitioner
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Following page is a development page to select an ehrId and fill the form using that id
          </p>
        </div>
      </div>
    </>
