      ...
      <div class="bg-white">
        <main>
          <div class="relative isolate ">
            ...
            <div class="mx-auto max-w-7xl px-5 lg:flex lg:h-screen items-center">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                <div class="max-w-xl">
                  <h2 className=" max-w-lg text-4xl font-semibold tracking-tight text-gray-900">
                ...
                <div class="mt-0 flex items-center gap-x-6">
                  <button
                    onClick={()=>_authenticate(1)}
                    class="flex items-center gap-x-2 rounded-md px-3.5 py-2.5 text-sm font-semibold text-primary hover:text-white hover:primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
                    <svg class="h-6 w-6" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_1_357)">
                        <path d="M0 22.6562C0 21.5172 0.923413 20.5938 2.0625 20.5938H11.3438C12.4828 20.5938 13.4062 21.5172 13.4062 22.6562V31.9375C13.4062 33.0766 12.4828 34 11.3438 34H2.0625C0.923413 34 0 33.0766 0 31.9375V22.6562Z" fill="#2563EB"></path>
                        <path d="M0 6.15625C0 5.01716 0.923413 4.09375 2.0625 4.09375H11.3438C12.4828 4.09375 13.4062 5.01716 13.4062 6.15625V15.4375C13.4062 16.5766 12.4828 17.5 11.3438 17.5H2.0625C0.923413 17.5 0 16.5766 0 15.4375V6.15625Z" fill="#2563EB"></path>
                        <path d="M16.5 6.15625C16.5 5.01716 17.4234 4.09375 18.5625 4.09375H27.8438C28.9828 4.09375 29.9062 5.01716 29.9062 6.15625V15.4375C29.9062 16.5766 28.9828 17.5 27.8438 17.5H18.5625C17.4234 17.5 16.5 16.5766 16.5 15.4375V6.15625Z" fill="white"></path>
                        <path d="M16.5 22.6562C16.5 21.5172 17.4234 20.5938 18.5625 20.5938H27.8438C28.9828 20.5938 29.9062 21.5172 29.9062 22.6562V31.9375C29.9062 33.0766 28.9828 34 27.8438 34H18.5625C17.4234 34 16.5 33.0766 16.5 31.9375V22.6562Z" fill="#2563EB"></path>
                        <path d="M19.0625 4.5H28.3438C29.2067 4.5 29.9062 5.19956 29.9062 6.0625V15.3438C29.9062 16.2067 29.2067 16.9062 28.3438 16.9062H19.0625C18.1996 16.9062 17.5 16.2067 17.5 15.3438V6.0625C17.5 5.19956 18.1996 4.5 19.0625 4.5Z" stroke="#5F5F5F"></path>
                        <path d="M21 2.0625C21 0.923413 21.9234 0 23.0625 0H32.3438C33.4828 0 34.4062 0.923413 34.4062 2.0625V11.3438C34.4062 12.4828 33.4828 13.4062 32.3438 13.4062H23.0625C21.9234 13.4062 21 12.4828 21 11.3438V2.0625Z" fill="#2563EB"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_1_357">
                          <rect width="34.4062" height="34" fill="white"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                    Sign in using Medblocks
                  </button>
                  <button
                    onClick={()=>_authenticate(0)}
                    class="flex items-center gap-x-2 rounded-md px-3.5 py-2.5 text-sm font-semibold text-primary hover:text-white hover:primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37.548 52.973">
                      <defs>
                    ...
                    Sign in using Karolinska
                  </button>
                </div>
              </div>
              <div class="py-5 items-center ">
                <img class="bg-primary px-5 py-5 rounded-xl w-64 lg:w-[560px] m-auto" src="/src/assets/images/zebra.png" alt="zebra_image" />
              </div>
            </div>
          </div>
        </main>
