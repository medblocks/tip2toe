...
const DeliveryView = () => {
  ...
  const _pregnancySectionData = FormData["delivery"]
  ...
  const addQuestion = (value:any) => {
    if(value.data){
      const path = `tip2toe.v0/symptom_sign_screening_questionnaire/any_event:0/delivery:${pregnancyQuestions.length}/symptom_or_sign_name`
  ...
  return (
    <>
      {pathname === "/questionnaire/delivery" ? (
      <div>
        {/* Title & Description */}
